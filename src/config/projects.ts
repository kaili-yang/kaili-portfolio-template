  ...
  export const githubProjects: Array<ProjectItemType> = [
    {
      ...
      link: { href: 'github.com/kaili-yang/devtoolset', label: 'Devtoolset' },
      gitStars: 203,
      gitForks: 67
    },
    {
      name: 'Kelly Yang Portfolio Template',
      description:
        'portfolio template by Kelly Yang',
      link: { href: 'github.com/kaili-yang/kaili-portfolio-template', label: 'Kelly Yang Portfolio Template' },
      gitStars: 229,
      gitForks: 30
    },
    {
      ...
      link: { href: 'github.com/kaili-yang/chrome-extension-plasmo-template', label: 'Chrome Extension Plasmo Template' },
      gitStars: 54,
      gitForks: 10
    },
    {
      ...
      link: { href: 'github.com/kaili-yang/awesome-indie-hacker-tools', label: 'Awesome Indie Hacker Tools' },
      gitStars: 815,
      gitForks: 69
    },
    {
      ...
      link: { href: 'github.com/kaili-yang/awesome-ai-directory', label: 'Awesome AI Directory' },
      gitStars: 40,
      gitForks: 7
    },
    {
      ...
      link: { href: 'github.com/kaili-yang/producthunt-daily-bot', label: 'Producthunt Daily Bot' },
      gitStars: 3,
      gitForks: 3
    },
    {
      ...
      link: { href: 'github.com/kaili-yang/Cantonese-Echoes', label: 'Cantonese Echoes' },
      gitStars: 1
    },
  ]
